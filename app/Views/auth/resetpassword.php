        ...
        <div class="container mt--8 pb-5">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <small>Please enter your valid email</small>
                            </div>
                            ...
                            <?php endif; ?>
                            <!-- NOTE: redirect to Auth controller function reset_password_process with data url -->
                            <form role="form" method="POST" action="<?= base_url('auth/reset_password_process/'.$dataUsers['uniq_id']); ?>">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" placeholder="Confirm New Password" type="password" name="conf_password">
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <a class="text-light"><small</small></a>
                        </div>
