...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="<?= base_url('assets_auth/img/brand/favicon.png') ?>"/>
...
<header>
	...
	<div class="heroe">
		...
		<h1>Welcome to CodeIgniter <?= $dataUsers['username']; ?>!!!</h1>

		<h2>The email you registered in this system is <b><?= $dataUsers['email']; ?></b></h2>
